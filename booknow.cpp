...
ReadNowWindow::ReadNowWindow(BaseWindow *parent)
...
void ReadNowWindow::printBook(const QString &book, const QString &author,
                              const QString &title) {
...
QString ReadNowWindow::getAuthorTitle() { return authorName_ + " " + title_; }
