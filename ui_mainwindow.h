...
public:
    ...
    QPushButton *goToProfileButton;
    QPushButton *goToReadingButton;
    QPushButton *goToLibraryButton;
    QPushButton *goToGamesButton;
    QPushButton *goToVideoButton;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        goToProfileButton = new QPushButton(centralwidget);
        goToProfileButton->setObjectName("goToProfileButton");
        goToProfileButton->setMinimumSize(QSize(55, 55));
        goToProfileButton->setMaximumSize(QSize(55, 55));
        QPalette palette;
        ...
        goToProfileButton->setPalette(palette);
        goToProfileButton->setAutoFillBackground(false);
        goToProfileButton->setStyleSheet(QString::fromUtf8("background-color: rgba(0, 0, 0, 0)"));
        goToProfileButton->setIconSize(QSize(40, 40));
        goToProfileButton->setAutoDefault(false);
        goToProfileButton->setFlat(true);

        HeaderLayout_3->addWidget(goToProfileButton, 0, Qt::AlignVCenter);

        goToReadingButton = new QPushButton(centralwidget);
        goToReadingButton->setObjectName("goToReadingButton");
        goToReadingButton->setMinimumSize(QSize(55, 55));
        goToReadingButton->setMaximumSize(QSize(55, 55));
        QPalette palette1;
        ...
        goToReadingButton->setPalette(palette1);
        goToReadingButton->setAutoFillBackground(false);
        goToReadingButton->setStyleSheet(QString::fromUtf8("background-color: rgba(0, 0, 0, 0)"));
        goToReadingButton->setIconSize(QSize(40, 40));
        goToReadingButton->setAutoDefault(false);
        goToReadingButton->setFlat(true);

        HeaderLayout_3->addWidget(goToReadingButton);

        goToLibraryButton = new QPushButton(centralwidget);
        goToLibraryButton->setObjectName("goToLibraryButton");
        goToLibraryButton->setMinimumSize(QSize(55, 55));
        goToLibraryButton->setMaximumSize(QSize(55, 55));
        QPalette palette2;
        ...
        goToLibraryButton->setPalette(palette2);
        goToLibraryButton->setAutoFillBackground(false);
        goToLibraryButton->setStyleSheet(QString::fromUtf8("background-color: rgba(0, 0, 0, 0)"));
        goToLibraryButton->setIconSize(QSize(40, 40));
        goToLibraryButton->setAutoDefault(false);
        goToLibraryButton->setFlat(true);

        HeaderLayout_3->addWidget(goToLibraryButton);

        goToGamesButton = new QPushButton(centralwidget);
        goToGamesButton->setObjectName("goToGamesButton");
        goToGamesButton->setMinimumSize(QSize(55, 55));
        goToGamesButton->setMaximumSize(QSize(55, 55));
        QPalette palette3;
        ...
        goToGamesButton->setPalette(palette3);
        goToGamesButton->setAutoFillBackground(false);
        goToGamesButton->setStyleSheet(QString::fromUtf8("background-color: rgba(0, 0, 0, 0)"));
        goToGamesButton->setIconSize(QSize(40, 40));
        goToGamesButton->setAutoDefault(false);
        goToGamesButton->setFlat(true);

        HeaderLayout_3->addWidget(goToGamesButton);

        goToVideoButton = new QPushButton(centralwidget);
        goToVideoButton->setObjectName("goToVideoButton");
        goToVideoButton->setMinimumSize(QSize(55, 55));
        goToVideoButton->setMaximumSize(QSize(55, 55));
        QPalette palette4;
...
#endif
        palette4.setBrush(QPalette::Disabled, QPalette::Accent, brush10);
        goToVideoButton->setPalette(palette4);
        goToVideoButton->setAutoFillBackground(false);
        goToVideoButton->setStyleSheet(QString::fromUtf8("background-color: rgba(0, 0, 0, 0)"));
        goToVideoButton->setIconSize(QSize(40, 40));
        goToVideoButton->setAutoDefault(false);
        goToVideoButton->setFlat(true);

        HeaderLayout_3->addWidget(goToVideoButton);

        goToQuizButton = new QPushButton(centralwidget);
        goToQuizButton->setObjectName("goToQuizButton");
        goToQuizButton->setMinimumSize(QSize(55, 55));
        goToQuizButton->setMaximumSize(QSize(55, 55));
        QPalette palette5;
...
#endif
        palette5.setBrush(QPalette::Disabled, QPalette::Accent, brush10);
        goToQuizButton->setPalette(palette5);
        goToQuizButton->setAutoFillBackground(false);
        goToQuizButton->setStyleSheet(QString::fromUtf8("background-color: rgba(0, 0, 0, 0)"));
        goToQuizButton->setIconSize(QSize(40, 40));
        goToQuizButton->setAutoDefault(false);
        goToQuizButton->setFlat(true);

        HeaderLayout_3->addWidget(goToQuizButton);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        goToProfileButton->setText(QString());
        goToReadingButton->setText(QString());
        goToLibraryButton->setText(QString());
        goToGamesButton->setText(QString());
        goToVideoButton->setText(QString());
        goToQuizButton->setText(QString());
    } // retranslateUi
