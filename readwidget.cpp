...
ReadWidget::ReadWidget(BaseWindow *parent)
...
void ReadWidget::displayBook(const QString &book, const QString &author,
                             const QString &title) {
...
QString ReadWidget::getBookTitle() { return author_ + " " + title_; }
